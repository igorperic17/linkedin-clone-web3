...
export const NEXT_PUBLIC_CHAIN_RPC_ENDPOINT = 'https://full-node.testnet-1.coreum.dev:26657/'
export const NEXT_PUBLIC_CHAIN_REST_ENDPOINT = 'https://full-node.testnet-1.coreum.dev:1317/'
export const NEXT_PUBLIC_CHAIN_EXPLORER = 'https://explorer.testnet-1.coreum.dev/'
