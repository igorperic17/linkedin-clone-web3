        ...
        <div>
          <div className="flex gap-6">
            <div className="flex flex-col items-start py-4 w-1/2">
              ...
              <input onChange={(e) => setFirstName(e.target.value)} value={firstName} type="text" placeholder="Enter the first name of the participant" className="w-[320px] focus:border-2 py-2 px-2 focus:rounded-md focus:border-gray-400 outline-none rounded-xl bg-secondary" />
            </div>
            <div className="flex flex-col items-start py-4 w-1/2">
              <label className="mr-4 mb-2 ml-2 text-left">Last name</label>
              <input onChange={(e) => setLastName(e.target.value)} value={lastName} type="text" placeholder="Enter the last name of the participant" className="w-[320px] focus:border-2 py-2 px-2 focus:rounded-md focus:border-gray-400 outline-none rounded-xl bg-secondary" />
            </div>
          </div>
          ...
          <div className="flex gap-6">
            <div className="flex flex-col items-start py-4 w-1/2">
              ...
              <input onChange={(e) => setEventName(e.target.value)} value={eventName} type="text" placeholder="Enter the event name" className="w-[320px] focus:border-2 py-2 px-2 focus:rounded-md focus:border-gray-400 outline-none rounded-xl bg-secondary" />
            </div>
            <div className="flex flex-col items-start py-4 w-1/2">
